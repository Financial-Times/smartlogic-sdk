...
func TestConceptMarshalJSON(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectedJSON: `{"skosxl:prefLabel":[{"skosxl:literalForm":[{"@value":"Test Person","@language":"en"}],"@type":["skosxl:Label"]}],"@type":["skos:Concept","http://www.ft.com/ontology/person/Person"],"skos:topConceptOf":{"@id":"http://www.ft.com/thing/ConceptScheme/8e564c83-669c-48d5-a208-81fb88a32802"},"http://www.ft.com/ontology/isDeprecated":[false]}`,
			/*
				{
				  "skosxl:prefLabel": [
					{
